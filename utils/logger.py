...
def set_logger(args):
    ...
    # case_name
    case_name = f'{args.prefix+"_" if args.prefix else ""}{args.dataset}_{args.method}_' \
                f'{args.data_source}_{args.cls_init}_{args.shots}shots_seed{args.seed}' \
                # f'_{args.temp_scheme}_{args.temperature}_' \
                # f'{args.T}_{args.threshold}'
    ...
    loss_logger.write(f'Epoch,Iter,Train_loss,Val_loss,Val_acc,Test_acc,Mask\n')
