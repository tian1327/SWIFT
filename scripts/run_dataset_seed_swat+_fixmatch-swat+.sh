                        ...
                        for seed in "${seeds[@]}"; do
                            for retrieval_split in "${retrieval_splits[@]}"; do
                                for unlabeled_split in "${unlabeled_splits[@]}"; do
                                    ...
                                    # model_path="/scratch/user/ltmask/SWAT/output/swat+_vitb32/output_semi-aves/semi-aves_finetune_fewshot_REAL-Prompt_4shots_seed1_10eps/stage1_model_best-epoch_10_best.pth"
