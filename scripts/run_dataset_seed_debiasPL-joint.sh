                                ...
                                for unlabeled_split in "${unlabeled_splits[@]}"; do
                                    for temp_scheme in "${temp_scheme_list[@]}"; do
                                        for temperature in "${temperature_list[@]}"; do
                                            ...
                                            # stage1_model_path="output/batch_DebiasPL-Joint_vitb32_openclip_laion400m_50epochs/output_stanford_cars/batch_DebiasPL-Joint_stanford_cars_debiasPL-joint_fewshot+retrieved+unlabeled_REAL-Prompt_8shots_seed1/stage1_model_best.pth"
